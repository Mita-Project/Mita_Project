...
{
    public class ServiceRecord_User_Configuration : BaseConfiguration<ServiceRecord_User>
    {
        public override void Configure(EntityTypeBuilder<ServiceRecord_User> builder)
        {
