...
{
    public class ServiceRecord_Material_Configuration : BaseConfiguration<ServiceRecord_Material>
    {
        public override void Configure(EntityTypeBuilder<ServiceRecord_Material> builder)
        {
