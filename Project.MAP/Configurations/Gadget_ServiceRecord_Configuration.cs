...
{
    public class Gadget_ServiceRecord_Configuration : BaseConfiguration<Gadget_ServiceRecord>
    {
        public override void Configure(EntityTypeBuilder<Gadget_ServiceRecord> builder)
        {
